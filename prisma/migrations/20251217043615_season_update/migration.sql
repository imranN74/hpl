/*
  ...
  - Added the required column `auctionDate` to the `Season` table without a default value. This is not possible if the table is not empty.
...
*/
-- AlterTable
ALTER TABLE "Season" ADD COLUMN     "auctionDate" TIMESTAMP(3) NOT NULL,
